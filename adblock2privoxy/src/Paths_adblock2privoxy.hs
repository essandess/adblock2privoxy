...
libdir     = "/opt/local/lib/adblock2privoxy"
dynlibdir  = "/opt/local/lib/adblock2privoxy"
datadir    = "/opt/local/share/adblock2privoxy"
libexecdir = "/opt/local/lib/adblock2privoxy"
